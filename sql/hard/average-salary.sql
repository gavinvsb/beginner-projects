...
-- With the same formula for the average salary comparison in February, the result is the same because both the department '1' and '2' have the same average salary with the company, which is 7000.
